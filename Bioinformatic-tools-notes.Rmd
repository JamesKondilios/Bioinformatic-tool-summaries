...
Identifys germline SNPs and indels via local re-assembly of haplotypes. It takes short-read sequencing data aligned against a reference genome. It is capible of identifying SNPs and indels simultaneously via local de-novo assembly of haplotypes. It produces a VCF or gVCF file with raw, unfiltered SNP and indel variants. 
