...
#*RUNNING FAT JOBS ONB RAIJIN* <br />
...
Steps: <br />
  First makes sketches/references <br />
  Secondly makes a distance matrix <br />
`-p` specifies how many cores we want to use <br />
`-t` specifies to output a table <br />

```{bash Mash, eval = FALSE}
module load mash
mash sketch -l /g/data/xe2/projects/cip-potato/data/reads/runs/run-1/*.fastq.gz -o data/xe2/projects/cip-potato/MashReferences/ -p 28 -s 20000
mash dist data/xe2/projects/cip-potato/MashReferences/*.msh -t -p 28
